                ...
                <div class="col-md-6 text-center text-lg-start mb-2 mb-lg-0">
                    <div class="d-inline-flex align-items-center">
                        <a class="text-decoration-none text-body pe-3" href=""><i
                                class="bi bi-telephone me-2"></i>+90585961214</a>
                        <span class="text-body">|</span>
                        <a class="text-decoration-none text-body px-3" href=""><i
                                class="bi bi-envelope me-2"></i>Oof@gmail.com</a>
                    </div>
                </div>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0">
                <a href="index.html" class="navbar-brand">
                    <h1 class="m-0 text-uppercase text-primary"><img src="img/about-img.png" id="logo" /></i>EKOSPOR
                    </h1>
                </a>
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="text-center mx-auto mb-5" style="max-width: 500px;">
                <h5 class="d-inline-block text-primary text-uppercase border-bottom border-5">Herhangi bir sorunuz var
                    mı?</h5>
                <h1 class="display-4">Lütfen Bizimle İletişime Geçmekten Çekinmeyin</h1>
            </div>
            <div class="row g-5 mb-5">
                <div class="col-lg-4">
                    <div class="bg-light rounded d-flex flex-column align-items-center justify-content-center text-center"
                        ...
                        <h6 class="mb-0">123 Sokak, Balçova, İzmir</h6>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="bg-light rounded d-flex flex-column align-items-center justify-content-center text-center"
                ...
                <div class="col-lg-4">
                    <div class="bg-light rounded d-flex flex-column align-items-center justify-content-center text-center"
                        ...
                        <h6 class="mb-0">Oof@gmail.com</h6>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12" style="height: 500px;">
                    <div class="position-relative h-100">
                        <iframe class="position-relative w-100 h-100"
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d200066.22996854997!2d26.91490732998233!3d38.41755964693917!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14bbd862a762cacd%3A0x628cbba1a59ce8fe!2zxLB6bWly!5e0!3m2!1str!2str!4v1734516349980!5m2!1str!2str"
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                if (empty($isim) || empty($email) || empty($mesaj)) {
                    ...
                    $sql = "INSERT INTO iletisim (isim, email, ders, mesaj) VALUES (?, ?, ?, ?)";
                    $stmt = $baglanti->prepare($sql);

                    if ($stmt) {
                        $stmt->bind_param("ssss", $isim, $email, $ders, $mesaj);

                        if ($stmt->execute()) {
                            $message = '<div class="alert alert-success">Mesajınız başarıyla gönderildi.</div>';
                        } else {
                            $message = '<div class="alert alert-danger">Bir hata oluştu. Lütfen tekrar deneyin.</div>';
                        }
                    } else {
                        $message = '<div class="alert alert-danger">Veritabanı bağlantısı başarısız oldu.</div>';
                    }
                }
            }
            ?>
                        ...
                        <form method="post" action="">
                            <div class="row g-3">
                                <div class="col-12 col-sm-6">
                                    <input type="text" class="form-control bg-light border-0" name="isim"
                                        placeholder="İsim" style="height: 55px;" required>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <input type="email" class="form-control bg-light border-0" name="email"
                                        placeholder="E-postanız" style="height: 55px;" required>
                                </div>
                                <div class="col-12">
                                    <input type="text" class="form-control bg-light border-0" name="ders"
                                        placeholder="Ders" style="height: 55px;">
                                </div>
                                <div class="col-12">
                                    <textarea class="form-control bg-light border-0" name="mesaj" rows="5"
