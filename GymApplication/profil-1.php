...
<body>
    ...
    <!-- Contact Start -->
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                if (empty($ad) || empty($email) || empty($antrenor) || empty($hizmet) || empty($tarih) || empty($saat)) {
                    $messageRandevu = '<div class="alert alert-danger">Lütfen tüm alanları doldurun.</div>';
                } else {
                    ...
                    if ($stmt) {
                        ...
                        if ($stmt->execute()) {
                            $messageRandevu = '<div class="alert alert-success">Randevu başarıyla oluşturuldu.</div>';
                        } else {
                            $messageRandevu = '<div class="alert alert-danger">Bir hata oluştu. Lütfen tekrar deneyin.</div>';
                        }
                    } else {
                        $messageRandevu = '<div class="alert alert-danger">Veritabanı hatası oluştu.</div>';
                    }
                }
            }
                }
            ...
            <div class="row gx-5">
                ...
                <div class="col-lg-6">
                    <div class="bg-white text-center rounded p-5">
                        ...
                        <?php if (!empty($messageRandevu)) echo $messageRandevu; ?>
    ...
    <div class="row justify-content-center position-relative" style="margin-top: -90px; z-index: 1;">
                <div class="col-lg-8">
